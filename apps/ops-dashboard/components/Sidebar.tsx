...
import { Users, Calculator, BarChart2 } from 'lucide-react'
  ...
  return (
    <aside className="w-64 flex-shrink-0 bg-[#1c1c1f] flex flex-col h-screen border-r border-zinc-800">
      <div className="px-5 py-5 border-b border-zinc-800">
        <div className="text-white font-bold text-base leading-tight tracking-tight">Nelson</div>
        <div className="text-zinc-500 text-xs leading-tight mt-0.5">Ops Console</div>
      </div>
